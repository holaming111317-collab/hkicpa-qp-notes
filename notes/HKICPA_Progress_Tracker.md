# HKICPA M7 & M9 備考進度追蹤表
考試日：2026-11-20 ｜ 開始日：2026-08-19 ｜ 模式：兩科並行・每週 10–15 小時・測驗 100% OTQ

## 進度總覽
| 週 | M7 章節 | 狀態 | M9 章節 | 狀態 | 測驗分數 (M7 / M9) |
|---|---|---|---|---|---|
| W1 (8/19–25) | Ch1 Financial Environment | ✏️ 測驗已改（3/5）| Ch1 Key Aspects of the Tax System in HK | ✅ 已完成（4/5）| 3 / 4 |
| W2 (8/26–9/1) | Ch2 Sources of Finance | ✏️ 測驗已改（2/5，需重測）| Ch2 Administration of the Tax System | 📘 教材已發放 | 2 / — |
...
| W13 (11/11–19) | 總衝刺（Cheat Sheet + Flashcards + 錯題本）| ⬜ | 同左 | ⬜ | 🎯 考試 |

狀態圖例：⬜ 未開始 ｜ 📘 教材已發放 ｜ ✏️ 測驗已提交 ｜ ✅ 已完成（測驗 ≥ 4/5）

> **2026-08-21 里程碑**：全部 22 章教材（M7 Ch2–16 + M9 Ch2–8）已一次過生成並上載至網站；Master Formula Sheet（M7，16 章）及 Master Section List（M9，8 章）已合併完成。之後每週只需按表操課：Study Pack → Flashcards → Quiz → 交答案批改。

## 錯題本 (Error Log) 與快問快答紀錄
> 已搬到獨立頁面，方便隨時温：👉 [錯題本 Error Log](錯題本-error-log.html)
> 每次 Phase 4 批改後更新嗰邊，呢度唔再重複記錄。
